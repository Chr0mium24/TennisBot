...
def main(argv: list[str]) -> int:
    ...
    try:
        ...
        if command == "benchmark":
            return run_yolo(["benchmark", *rest], extra=detect_extra(rest))
        if command == "detect-gui":
            return run_yolo(["detect-gui", *rest], extra=detect_extra(rest))
        if command == "detect-video":
            return run_yolo(["detect-video", *rest], extra=detect_extra(rest))
...
def detect_extra(args: list[str]) -> str | None:

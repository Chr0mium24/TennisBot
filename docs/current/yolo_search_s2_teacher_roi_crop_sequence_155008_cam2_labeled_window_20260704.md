...
- Search frames: `106`
- ROI frames: `28`
- Expanded ROI frames: `15`
- Same-frame search-on-miss frames: `0`
- Lock acquisitions: `6`
- Lost events: `6`
- Detection updates used by tracker: `16`

## Result

| mode | profile | imgsz | images | gt | TP | FP | FN | recall | precision | median ms/img | p95 ms/img | est stereo FPS | notes |
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| stateful_roi | 960x540->1280x720 | 640/320 | 134 | 44 | 9 | 9 | 35 | 0.205 | 0.500 | 36.66 | 43.82 | 13.64 | search=106 roi=28 expanded=15 acquired=6 lost=6 |

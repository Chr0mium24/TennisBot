...
- Search frames: `99`
- ROI frames: `35`
- Expanded ROI frames: `19`
- Same-frame search-on-miss frames: `0`
- Lock acquisitions: `6`
- Lost events: `6`
- Detection updates used by tracker: `20`

## Result

| mode | profile | imgsz | images | gt | TP | FP | FN | recall | precision | median ms/img | p95 ms/img | est stereo FPS | notes |
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| stateful_roi | 960x540->1280x720 | 640/320 | 134 | 44 | 9 | 18 | 35 | 0.205 | 0.333 | 44.02 | 45.34 | 11.36 | search=99 roi=35 expanded=19 acquired=6 lost=6 |

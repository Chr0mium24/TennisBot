...
- Search frames: `101`
- ROI frames: `33`
- Expanded ROI frames: `9`
- Same-frame search-on-miss frames: `0`
- Lock acquisitions: `3`
- Lost events: `3`
- Detection updates used by tracker: `27`

## Result

| mode | profile | imgsz | images | gt | TP | FP | FN | recall | precision | median ms/img | p95 ms/img | est stereo FPS | notes |
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| stateful_roi | 960x540->1280x720 | 512/320 | 134 | 44 | 22 | 8 | 22 | 0.500 | 0.733 | 17.57 | 18.13 | 28.46 | search=101 roi=33 expanded=9 acquired=3 lost=3 |

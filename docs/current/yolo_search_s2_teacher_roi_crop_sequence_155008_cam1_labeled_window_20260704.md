...
- Search frames: `100`
- ROI frames: `24`
- Expanded ROI frames: `12`
- Same-frame search-on-miss frames: `0`
- Lock acquisitions: `6`
- Lost events: `5`
- Detection updates used by tracker: `13`

## Result

| mode | profile | imgsz | images | gt | TP | FP | FN | recall | precision | median ms/img | p95 ms/img | est stereo FPS | notes |
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| stateful_roi | 960x540->1280x720 | 640/320 | 124 | 49 | 9 | 5 | 40 | 0.184 | 0.643 | 35.89 | 37.30 | 13.93 | search=100 roi=24 expanded=12 acquired=6 lost=5 |

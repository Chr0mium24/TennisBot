...
- Search model: `tools/yolo/workspace/runs/training/search_s1_yolo26n_fullframe_imgsz512_20260704/weights/best.pt`
...
- Search frames: `41`
- ROI frames: `93`
- Expanded ROI frames: `57`
- Same-frame search-on-miss frames: `0`
- Lock acquisitions: `28`
- Lost events: `27`
- Detection updates used by tracker: `40`

## Result

| mode | profile | imgsz | images | gt | TP | FP | FN | recall | precision | median ms/img | p95 ms/img | est stereo FPS | notes |
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| stateful_roi | 960x540->1280x720 | 512/320 | 134 | 44 | 12 | 47 | 32 | 0.273 | 0.203 | 12.56 | 20.71 | 39.80 | search=41 roi=93 expanded=57 acquired=28 lost=27 |

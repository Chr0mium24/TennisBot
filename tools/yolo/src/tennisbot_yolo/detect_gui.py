...
def add_detect_gui_parser(subparsers: argparse._SubParsersAction[argparse.ArgumentParser]) -> None:
    parser = subparsers.add_parser("detect-gui", help="Open USB cameras and render pure YOLO detection boxes.")
    parser.add_argument("--devices", help="Comma-separated camera devices. Default: /dev/video0,/dev/video2.")
    parser.add_argument("--left-device", help="Left camera device; ignored when --devices is provided.")
    parser.add_argument("--right-device", help="Right camera device; ignored when --devices is provided.")
    ...
    parser.add_argument("--device", default=None, help="Ultralytics device, for example cpu, 0, or 0,1.")
    parser.add_argument("--class-id", type=int, default=0, help="Class id to draw. Use -1 to draw all classes.")
    parser.add_argument("--tile", action="store_true", help="Use tiled YOLO inference for small 4K balls.")
    parser.add_argument("--tile-width", type=int, default=2048)
    parser.add_argument("--tile-height", type=int, default=1216)
    parser.add_argument("--tile-overlap", type=int, default=160)
    parser.add_argument("--display-width", type=int, default=720)
    parser.add_argument("--warmup-frames", type=int, default=5)
    parser.add_argument("--window", default="TennisBot YOLO Detect")
    parser.add_argument("--dry-run", action="store_true", help="Print resolved configuration without opening cameras.")
